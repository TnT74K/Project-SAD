...
| ORG profile edit page                           | `Fix`: They can't set price for their appointments.          | Abolfazl         |        |

## Fix: Part Two

| Page to improve           | Description                                                  | Responsible      | Branch |
| ------------------------- | ------------------------------------------------------------ | ---------------- | ------ |
| `New`:  About Us          | `Add`: give a small description about the system             |                  |        |
| `New`: ORG register guide | `Add`: from homepage, they can enter this page; We explain how to register page and tell them about the rules. |                  |        |
| Search page               | `Add`: فیلتر برای کسب و کارهای برتر                          | Mohammad Hossein |        |
| Footer                    | `Add`: Mock emails + support numbers                         | Abolfazl         |        |
