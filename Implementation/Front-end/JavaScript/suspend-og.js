...
let businesses = [
  {
    name: "فروشگاه آنلاین فروش لباش",
    category: "فروشگاه آنلاین",
    owner: "سعید محمدی",
    blocked: false
  },
  {
    name: "شرکت نرم‌افزاری پارس",
    category: "فناوری اطلاعات",
    owner: "نیلوفر احمدی",
    blocked: false
  },
  {
    name: "رستوران سنتی ارارات",
    category: "خوراک و آشامیدنی",
    owner: "آرمین کریمی",
    blocked: true
  },
  {
    name: "آژانس گردشگری پرواز",
    category: "گردشگری",
    owner: "مریم حسینی",
    blocked: false
  },
  ...
  {
    name: "آموزشگاه زبان گلستان",
    category: "آموزش",
    owner: "فاطمه قاسمی",
    blocked: true
  },
  {
    name: "تولیدی پوشاک البرز",
    category: "پوشاک",
    owner: "محمد رستمی",
    blocked: false
  },
  {
    name: "مشاورین مالی آریا",
