/**
 * ╔══════════════════════════════════════════════════════╗
 * ║         مدیریت تبلیغات — رزروسنتر                   ║
 * ║  فایل جاوااسکریپت: app.js                            ║
 * ║                                                      ║
 * ║  توابع اصلی:                                          ║
 * ║    showForm(id)   — نمایش فرم افزودن یا مودال ویرایش ║
 * ║    showList()     — بازگشت به لیست کارت‌ها            ║
 * ║    submitForm()   — ثبت تبلیغ جدید                   ║
 * ║    openModal(id)  — باز کردن مودال ویرایش            ║
 * ║    closeModal(e)  — بستن مودال ویرایش                ║
 * ║    saveEdit()     — ذخیره تغییرات ویرایش             ║
 * ║    deleteCard(btn)— حذف کارت تبلیغ                  ║
 * ║    updateCount()  — به‌روزرسانی شمارنده تبلیغات      ║
 * ╚══════════════════════════════════════════════════════╝
 */
